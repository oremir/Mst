class MSword {
    ...
    reequip(ef) {
        ...
        if (efi !== -1) {
            this.fr_left = parseInt(Mst.items[efi].properties.tool_fr_left);
            this.fr_right = parseInt(Mst.items[efi].properties.tool_fr_right);
            this.cut_type = Mst.items[efi].properties.cut_type;
            if (this.cut_type === "throw") {
                this.bullet_frame = Mst.items[efi].properties.tfr;
            }
        } else {
            this.fr_left = 0;
            this.fr_right = 0;
